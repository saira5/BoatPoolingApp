...
public class Verification extends AppCompatActivity implements View.OnClickListener {
    EditText etemail,etcode,etnewPass;
    ProgressDialog pDialog;
    Button verify;
    String email,code,pass;
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.verify) {
            ...
            if ((awesomeValidation.validate())&& (validation())) {
                new Verify().execute(email,code,pass);
            }
    ...
    class Verify extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost(Urls.verify_pass);
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
                nameValuePairs.add(new BasicNameValuePair("username", params[0]));
                nameValuePairs.add(new BasicNameValuePair("secretToken", params[1]));
                nameValuePairs.add(new BasicNameValuePair("newPassword", params[2]));
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (result.contains("Invalid Username / Verification Code !")) {
                ...
                else if(result.contains("Password Reset Successfully")) {
    ...
    public boolean validation(){
        ...
        if(pass.isEmpty())
        {
            etnewPass.setError(getString(R.string.invalid_password));
            validate= false;
        }
