//package com.example.boatpoolingapp.utils;
//
//
...
//
//import com.hypernym.eLaundry.R;
//import com.hypernym.eLaundry.enumerations.AnimationEnum;
//
...
//            context.finish();
//    }
//    public static void startActivity_test(Activity context, Class<?> class_, boolean isFinish) {
//        Intent intent = new Intent(context, class_);
...
//        Intent intent = new Intent(context, class_);
//        intent.putExtra(SyncStateContract.Constants.FRAGMENT_NAME, fragmentName);
//        intent.putExtra(SyncStateContract.Constants.DATA, bundle);
//        context.startActivity(intent);
...
//    }
//
//    public static void setTitle(Toolbar toolbar, String title, boolean padding){
//        toolbar.setTitle(title);
//        ActivityUtils.centerToolbarTitle(toolbar, padding);
//        toolbar.setTitleTextColor(ContextCompat.getColor(toolbar.getContext(),android.R.color.black));
//    }
////    public static void startHomeActivity(Activity context, Class<?> class_, String fragmentName, AnimationEnum animationType) {
////        Intent intent = new Intent(context, class_);
////        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
////        intent.putExtra(Constants.FRAGMENT_NAME, fragmentName);
////        context.startActivity(intent);
