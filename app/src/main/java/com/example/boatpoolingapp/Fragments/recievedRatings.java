 ...
 * {@link recievedRatings.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link recievedRatings#newInstance} factory method to
 * create an instance of this fragment.
 */
public class recievedRatings extends Fragment {
     ...
     * @return A new instance of fragment recievedRatings.
     */
    // TODO: Rename and change types and number of parameters
    public static recievedRatings newInstance(String param1, String param2) {
        recievedRatings fragment = new recievedRatings();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_recieved_ratings, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new recievedRatingCall().execute();
    ...
    private class recievedRatingCall extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                HttpPost httpPost=new HttpPost(Urls.recievedRatings);
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                if(obj.getString("error").contains("false")){
                    ...
                    adapter = new recyclerViewRatings(reviewsList, getContext(),"driver");
